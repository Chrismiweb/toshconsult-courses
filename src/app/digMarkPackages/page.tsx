...
export default function DigPackages(){
    const packages = [
        {
            img: img1,
            topic: "Digital Marketing Fundamentals",
            sub: "The beginners courses to be a pro. in Digital Marketing",
            price: "50,000",
            discount: "50% OFF",
            fprice :"N100,000",
            ...
            crs2: "SEM",
            crs3: "SMM",
            crs4: "Content Marketing",
            crs5: "Marketing Analytics",
            crs6: "Public Relation",
            dot: <LuDot/>,
            beginner: "Beginner",
            dur: "3 weeks",
            time: "MON-FRI",
        ...
        },
        {
            ...
            sub: "The beginners courses to be a pro. in Content Creation & Monetization",
            // price: "50,000",
            // discount: "50% OFF",
            // fprice :"N100,000",
            mark: <IoCheckmarkOutline/>,
            crs1: "SEO Optimization for Content",
            crs2: "Understanding Content Analytics",
            crs3: "Content Strategy & Planning",
            crs4: "Copywriting Basics",
            crs5: "Content Storytelling",
            crs6: "Content Editing & Proofreading",
            dot: <LuDot/>,
            beginner: "Beginner",
            dur: "3 weeks",
            time: "MON-FRI",
        ...
        
        {
            ...
            sub: "The beginners courses to be a pro. in Email Marketing",
            price: "50,000",
            discount: "50% OFF",
            fprice :"N100,000",
            mark: <IoCheckmarkOutline/>,
            crs1: "Email Marketing",
            crs2: "Email Marketing Metrics",
            crs3: "Email Design",
            crs4: "Email Automation",
            crs5: "GDPR and CCPA Compliance",
            crs6: "Compliance with CAN-SPAM",
            dot: <LuDot/>,
            beginner: "Beginner",
            dur: "3 weeks",
            time: "MON-FRI",
    ...
    return(
        <div className="w-[100%] bg-white flex flex-col justify-center items-center ">
            <div className="flex flex-col justify-center py-[30px] items-center">
                <h1 className="md:text-[40px] text-[30px] text-black font-bold w-[80%] lg:w-[45%] text-center">Our curated Digital Marketing courses</h1>
