import img1 from '../image/figma.png'
import img2 from '../image/adobexd.png'
import img3 from '../image/wire.png'
...
export default function UiuxPackages(){
    const packages = [
        {
            img: img1,
            topic: "Fundamental of Figma",
            sub: "The beginners courses to be a pro. in Figma",
            price: "50,000",
            discount: "50% OFF",
            fprice :"N100,000",
            mark: <IoCheckmarkOutline/>,
            crs1: "Project Organization",
            crs2: "Design Systems",
            crs3: "Figma Resources and Support",
            crs4: "Layout and Composition",
            crs5: "Using Design Tools",
            crs6: "Workspace Navigation",
            dot: <LuDot/>,
            beginner: "Beginner",
            dur: "3 weeks",
            time: "MON-FRI",
        ...
        {
            img: img2,
            topic: "Fundamental Of Adobe XD",
            sub: "The beginners courses to be a pro. in Adobe XD",
            // price: "50,000",
            // discount: "50% OFF",
            // fprice :"N100,000",
            mark: <IoCheckmarkOutline/>,
            crs1: "Design Thinking Principles",
            crs2: "Artboards and Layouts",
            crs3: "Plugin Integration",
            crs4: "Advanced Design Techniques",
            crs5: "Design Handoff",
            crs6: "Animations and Microinteractions",
            dot: <LuDot/>,
            beginner: "Beginner",
            dur: "3 weeks",
            time: "MON-FRI",
        ...
        {
            img: img3,
            topic: "Wireframing, Prototyping, And User Testing",
            ...
            crs1: "Design Thinking Principles",
            crs2: "Artboards and Layouts",
            crs3: "Project Organization",
            crs4: "Design Systems",
            crs5: "Layout and Composition",
            crs6: "Design Handoff",
            dot: <LuDot/>,
            beginner: "Beginner",
            dur: "3 weeks",
