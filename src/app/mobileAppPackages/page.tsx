import img1 from '../image/reactnative.png'
import img2 from '../image/flutter.png'
import img3 from '../image/expo.png'
...
export default function MobileAppPackages(){
    const packages = [
        {
            img: img1,
            topic: "React Native and React Native",
            sub: "The beginners courses to be a pro. in React Native and React Native",
            price: "50,000",
            discount: "50% OFF",
            fprice :"N100,000",
        ...
        },
        {
            img: img2,
            topic: "Flutter",
            sub: "The beginners courses to be a pro. in Flutter",
            price: "50,000",
            discount: "50% OFF",
            fprice :"N100,000",
            mark: <IoCheckmarkOutline/>,
            crs1: "Widget Fundamentals",
            crs2: "Animations and Transitions",
            crs3: "Firebase Integration",
            crs4: "Data Persistence",
            crs5: "Package Management",
            crs6: "Web Support (Beta)",
            dot: <LuDot/>,
            beginner: "Beginner",
            dur: "3 weeks",
            time: "MON-FRI",
        ...
        },
        {
            img: img3,
            topic: "Expo",
            sub: "The beginners courses to be a pro. in Expo",
            price: "50,000",
            discount: "50% OFF",
            fprice :"N100,000",
            mark: <IoCheckmarkOutline/>,
            crs1: "JSX for Building UIs",
            crs2: "Varaible",
            crs3: "mapping",
            crs4: "Looping",
            crs5: "Expo APIs",
            crs6: "Performance Optimization",
            dot: <LuDot/>,
            beginner: "Beginner",
            dur: "3 weeks",
            time: "MON-FRI",
    ...
    return(
        <div className="w-[100%] bg-white flex flex-col justify-center items-center ">
            <div className="flex flex-col justify-center py-[30px] items-center">
                <h1 className="md:text-[40px] text-[30px] text-black font-bold w-[80%] lg:w-[45%] text-center">Our curated Mobile App development courses</h1>
